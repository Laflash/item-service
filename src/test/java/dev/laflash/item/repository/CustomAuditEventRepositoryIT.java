package dev.laflash.item.repository;

import static dev.laflash.item.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
import static org.assertj.core.api.Assertions.assertThat;

import dev.laflash.item.ItemServiceApp;
import dev.laflash.item.config.Constants;
import dev.laflash.item.config.TestSecurityConfiguration;
import dev.laflash.item.config.audit.AuditEventConverter;
import dev.laflash.item.domain.PersistentAuditEvent;
